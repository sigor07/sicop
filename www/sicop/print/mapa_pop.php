...
$txt = "Mapa populacional gerado no dia $data_sf às $hora";
$pdf->Cell( 0, '', $txt, 0, 1, 'C', 0, '', 0, false, 'T', 'M' );
...
/**
 * DESENHAR OS QUADRADOS DAS MOVIMENTAÇÕES
 */
...
// definindo a posição do ponteiro em relação a margem esquerda
$pdf->SetX($x);
$txt = 'TIPO DE MOVIMENTAÇÃO';
$pdf->Cell( $w_maior, '', $txt, 1, 0, 'C', 0, '', 0, false, 'T', 'M' );

$txt = 'QUANTIDADE';
$pdf->Cell( $w_menor, '', $txt, 1, 0, 'C', 0, '', 0, false, 'T', 'M' );
...
$txt = 'QUANTIDADE';
$pdf->Cell( $w_menor, '', $txt, 1, 1, 'C', 0, '', 0, false, 'T', 'M' );
...
$pdf->SetX($x);
$txt = 'Inclusão';
$pdf->Cell( $w_maior, '', $txt, 1, 0, 'L', 0, '', 0, false, 'T', 'M' );
