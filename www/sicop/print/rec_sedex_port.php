...
$pag        = link_pag();
$tipo       = '';
$motivo_pag = 'IMPRESSÃO DO RECIBO DO SEDEX DA PORTARIA P/ INCLUSÃO';
...
$msg['text'] = "Impressão do recibo do sedex da portaria para a inclusão. \n\n $sedex";
...
<html lang="pt-br" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="Javascript:window.print();self.window.close()">
        ...
        <div class="corpo">
            ...
            <br />
            <p class="par_corpo">Declaro, para os devidos fins, que recebi do Setor de Portaria, em data supra, o(s) sedex relacionado(s):</p>
            <br />
            ...
            if ( $quebra ) {
            ?>
            <p align="right" class="par_min">Recibo de encaminhamento de sedex portaria/inclusão - Página: <?php echo $num_pag++; ?> - Usuário: <?php echo $iduser?>; Computador: <?php echo $maquina; ?>; em <?php echo date( 'd/m/Y \à\s H:i' )?></p>
