...
<p class="descript_page">Mensagens enviadas</p>

<p class="link_common"><a href="msg.php?p=ent">Mensagens recebidas</a> | Mensagens enviadas<?php if ( $n_msg >= 3 ) { ?> | <a href="wmsg.php">Escrever mensagem</a><?php } ?></p>
...
if ( $cont_msg_in < 1 ) { // se o número de ocorrências for menor do que 1, mostra a mensagem
    ...
    <?php if ( $n_msg >= 3 ) { ?><form action="<?php echo SICOP_ABS_PATH ?>send/sendmsg.php" method="post" name="deletamsg" id="deletamsg" onSubmit="return confirmExcl()"><?php } ?>
        <table class="lista_busca">
            ...
            <?php while ( $d_msg_in = $q_msg_in->fetch_assoc() ) { ?>

            <tr class="even">
                <td class="num_od"><img src="<?php echo SICOP_SYS_IMG_PATH; ?>msg_read.png" alt="" width="20" height="13" /></td>
                <td class="msg_user"><?php echo $d_msg_in['nome_para']; ?></td>
                <td class="msg_ass"><a href="detalmsgout.php?idmsg=<?php echo $d_msg_in['idmsg']; ?>"><?php echo $d_msg_in['msg_titulo']; ?></a></td>
                <td class="desc_data"><?php echo $d_msg_in['msg_add_f']; ?></td>
            ...
            <tr>
                <td height="38" colspan="5" align="right">
                    ...
                    <input type="hidden" name="tipo_msg" id="tipo_msg" value="2" />
                </td>
            </tr>
