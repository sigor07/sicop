...
$pag  = link_pag();
$tipo = '';
$motivo_pag = 'EXPORTAÇÃO DA LISTA DE AUDIÊNCIAS PARA EXCEL';
...
$objPHPExcel = new PHPExcel();
    ...
    // Set properties
$objPHPExcel->getProperties()->setCreator("SICOP - Sistema de Controle Prisional")
                             ->setLastModifiedBy("SICOP - Sistema de Controle Prisional")
