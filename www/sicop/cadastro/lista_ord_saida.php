...
?>
            ...
            <?php if ( $n_cadastro >= 3 ) { ?>
            <p class="link_common" style="margin-top: 5px;"><a href="add_ord_saida.php">Cadastrar ordem de saída</a></p>
            <?php } ?>
...
?>
                <tr class="even">
                    ...
                    <?php }; ?>
                    <?php if ( $n_cadastro >= 3 ) {  ?>
                    <td class="tb_bt"><a href='javascript:void(0)' onclick='drop_ord_saida( <?php echo $id_ord_saida; ?>, 3 )' title="Excluir esta ordem de saída"><img src="<?php echo SICOP_SYS_IMG_PATH; ?>b_drop.png" alt="Excluir esta ordem de saída" class="icon_button" /></a></td>
                    <?php }; ?>
                </tr>
