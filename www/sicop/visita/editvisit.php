...
if ( $n_rol < $n_rol_n ) {
    ...
    $msg = array();
    $msg['tipo']  = 'perm';
    $msg['entre_ch'] = 'ALTERAÇÃO DE DADOS DO VISITANTE';
    get_msg( $msg, 1 );
...
if ( empty( $idvisit ) ) {
    ...
    $msg = array();
    $msg['tipo']  = 'atn';
    $msg['text']  = "Tentativa de acesso direto à página. Identificador do visitante em branco. ( ALTERAÇÃO DE DADOS DO VISITANTE )";
    get_msg( $msg, 1 );
...
if ( !$query_visit ) {
    ...
    $msg = array();
    $msg['tipo']  = 'err';
    $msg['text']  = 'Falha na consulta ( ALTERAÇÃO DE DADOS DO VISITANTE ).';
    $msg['linha'] = __LINE__;
    get_msg( $msg, 1 );
...
if ( $contv < 1 ) {
    ...
    $msg = array();
    $msg['tipo']  = 'err';
    $msg['text']  = 'A consulta retornou 0 ocorrências ( ALTERAÇÃO DE DADOS DO VISITANTE ).';
    $msg['linha'] = __LINE__;
    get_msg( $msg, 1 );
...
?>
            ...
            <form action="<?php echo SICOP_ABS_PATH ?>send/sendvisit.php" method="post" name="visit_up" id="visit_up" onSubmit="return validacadvisit();">
                    ...
                    <tr>
                        ...
                        <td width="181">Parentesco:
                            <select name="idparentesco" class="CaixaTexto" id="idparentesco">
                                ...
                                <option value="<?php echo $dados_parent['idparentesco']; ?>" <?php echo $dados_parent['idparentesco'] == $d_visit['cod_parentesco'] ? 'selected="selected"' : ''; ?>><?php echo $dados_parent['parentesco']; ?></option>
                                <?php }; ?>
                            </select>
                        </td>
