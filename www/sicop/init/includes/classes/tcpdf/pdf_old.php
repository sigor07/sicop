...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        $pag_size = 210;
        $pic_size = 17;
        $position = ( $pag_size - $pic_size ) / 2;

        // Logo
        $image_file = SICOP_DOC_ROOT . SICOP_SYS_IMG_PATH . 'brasao.jpg';
        $this->Image( $image_file, $position, 5, $pic_size, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false );

//        $image_file = SICOP_DOC_ROOT . SICOP_SYS_IMG_PATH . 'logo_sap.png';
//        $this->Image( $image_file, 170, 10, 28, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false );
        ...
        $this->Cell( 170, 5, $secretaria, 0, 1, 'C', 0, '', 0, false, 'T', 'C' );

        // configurar a fonte
        $this->SetFont( 'helvetica', 'N', 9 );

        $this->Cell( 170, 4, $coordenadoria, 0, 1, 'C', 0, '', 0, false, 'T', 'C' );
        $this->Cell( 170, 4, $unidadecurto, 0, 1, 'C', 0, '', 0, false, 'T', 'C' );
    ...
    public function getQualiFoto( $d_det ){
