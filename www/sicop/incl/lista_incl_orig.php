...
?>
        ...
        <script type="text/javascript" >
            ...
            <?php if ( $n_det_alt >= 1 ){?>
            <form action="<?php echo SICOP_ABS_PATH; ?>send/sendincl.php" method="post" name="senddet" id="senddet" onSubmit="return validalistaincl()">
            <?php } ?>
                ...
                <table class="lista_busca grid" id="tb_order">
                    ...
                    <tbody>
                        ...
                        <tr class="even">
                            ...
                            <?php if ( $n_det_alt >= 1 and !empty( $d_det['matricula'] ) ) {  ?> <input type="image" height="16" src="<?php echo $img_sys_path; ?>camera.gif" name="alter_foto_det[]" value="<?php echo $d_det['iddetento'] ;?>" title="Cadastrar/Alterar a foto d<?php echo SICOP_DET_PRON_L; ?> <?php echo SICOP_DET_DESC_L; ?>" /> <?php }; ?>

                            </td>
                            <td class="tb_ck">
                                <input type="image" height="16" src="<?php echo $img_sys_path; ?>q_img.png" name="print_quali_det[]" value="<?php echo $d_det['iddetento'] ;?>" title="Imprimir a qualificativa d<?php echo SICOP_DET_PRON_L; ?> <?php echo SICOP_DET_DESC_L; ?>" />
                            </td>

                            <td class="tb_ck">
                                <input type="image" height="16" src="<?php echo $img_sys_path; ?>f_img.png" name="print_ficha_det[]" value="<?php echo $d_det['iddetento'] ;?>" title="Imprimir a ficha de identificação d<?php echo SICOP_DET_PRON_L; ?> <?php echo SICOP_DET_DESC_L; ?>" />
                            </td>
                            <td class="tb_ck">
                                <input type="image" height="16" src="<?php echo $img_sys_path; ?>c_img.png" name="print_card_det[]" value="<?php echo $d_det['iddetento'] ;?>" title="Imprimir o cartão de identidade d<?php echo SICOP_DET_PRON_L; ?> <?php echo SICOP_DET_DESC_L; ?>" />
                            </td>
                            <td class="tb_ck">
...
<!--                                <a href="#" title="Imprimir a lista do pecúlio deste detento" onClick="javascript: ow('print_pec.php?iddet=<?php echo $d_det['iddetento']; ?>&targ=1', '830', '600'); return false" >P</a>-->
                            </td>
                            <td class="tb_ck">
                                <?php if ( $n_det_alt >= 1 ) {?>
                                <input name="iddet[]" type="checkbox" id="iddet" class="mark_row" value="<?php echo $d_det['iddetento'];?>" />
                                <?php }?>
                            </td>
                        </tr>
                        <?php } // fim do while ?>
                    ...
                    <tfoot>
                        <tr>
                            <td  class="tb_ck_leg" colspan="12">todos:</td>
                ...
                <div class="form_bts">
                    <input class="form_bt" name="quali" type="submit" value="Imprimir ficha qualificativa" />
                    <input class="form_bt" name="ficha" type="submit" value="Imprimir ficha de identificação" />
                    <input class="form_bt" name="cartao" type="submit" value="Imprimir cartão de identidade" />
                </div>

                <div class="form_bts">
                    <input class="form_bt" name="doc_rol" type="button" value="Imprimir documentos do rol de visitas" />
                </div>
